...
public class UserController {
    ...
    @Autowired
     public UserController(RiderService riderService){
        this.riderService = riderService;
    }

    @GetMapping("/user/findUserRouteById")
    public ResponseEntity<Map<String,Object>> findUserRouteById(@RequestBody Map<String,Object> requestBody){
         ...
         if(stops!=null){
          ...
          response.put("message","User stop details not found");
